...
<img align="right" width="600" src="assets/git-status.png" alt="git status" />
...
<img style="float: right;" width=550 src="assets/submit-pull-request.png" alt="submit pull request" />
